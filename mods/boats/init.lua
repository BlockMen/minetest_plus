...
local boat = {
	physical = true,
	collisionbox = {-0.42,-0.15,-0.45,0.42,0.3,0.45},
	visual_size = {x=1,y=1},
	visual = "mesh",
	mesh = "boat.x",
...
function boat:on_rightclick(clicker)
	...
	elseif not self.driver then
		self.driver = clicker
		clicker:set_attach(self.object, "", {x=0.5,y=11,z=-3}, {x=0,y=0,z=0})
...
minetest.register_craftitem("boats:boat", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		local obj = minetest.add_entity(pointed_thing.under, "boats:boat")
		if obj then
